            ...
            <div key={item.title} className="relative group h-full flex items-center">
              {item.dropdown ? (
                ...
                >
                   ...
                   <span className={openDropdown === item.title ? "text-[#88bf42]" : "text-foreground"}></span>
                  ...
                  <div className="w-64 flex-shrink-0"> {/* Increased fixed width for the main column */}
                      <Link
                        ...
                        className={cn(
                          ...
                          "focus:outline-none focus-visible:ring-2 focus-visible:ring-ring",
                          openDropdown === item.title ? "border border-[#88bf42]" : "border border-transparent" // Highlight border
                        )}
